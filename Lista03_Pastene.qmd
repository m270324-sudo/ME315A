...
15. As seguintes cláusulas WHERE são logicamente equivalentes?
  ...
  1. WHERE STATE = 'MA' AND (ACRES \> 1000 OR FEE = 0.0)
  2. WHERE (STATE = 'MA' AND ACRES \> 1000) OR (STATE = 'MA' AND FEE = 0.0)
...
16. As seguintes cláusulas WHERE são logicamente equivalentes?
  ...
  1. WHERE STATE = 'MA' OR (ACRES \> 1000 AND FEE = 0.0) 
  2. WHERE (STATE = 'MA' OR ACRES \> 1000) AND (STATE = 'MA' OR FEE = 0.0)

São logicamente equivalente.
...
17. As seguintes cláusulas WHERE são logicamente equivalentes?
  ...
  2. WHERE NOT ACRES \< 50 AND NOT STATE = 'MA'    3. WHERE ACRES \>= 50 OR STATE \<\> 'MA'
 
 1 e 3 são equivalente porém 2 não 
